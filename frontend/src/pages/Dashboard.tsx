...
export function Dashboard(): JSX.Element {
  ...
  useLayoutEffect(() => {
    ...
    const updateBannerOverlayTop = (): void => {
      ...
      const nextTop = Math.max(12, dividerRect.bottom + 6);
      const nextRight = Math.max(14, tokenCardRect ? window.innerWidth - tokenCardRect.right : window.innerWidth - contentRect.right);
      const nextWidth = Math.max(320, tokenCardRect ? tokenCardRect.width - 10 : (contentRect.width - DASHBOARD_METRICS_GAP_PX) / 2);
