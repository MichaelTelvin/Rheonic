...
This document describes product direction and positioning. For exact implemented runtime behavior and API semantics, use the internal protect spec, thresholds map, and API spec.
