...
class _JsonFormatter(logging.Formatter):
    def format(self, record: logging.LogRecord) -> str:
        ...
        payload = {
            ...
            "env": _ENV_NAME,
            "trace_id": _resolve_string(getattr(record, "trace_id", None)) or get_trace_id() or generate_trace_id(),
            "span_id": _resolve_string(getattr(record, "span_id", None)) or get_span_id() or generate_span_id(),
