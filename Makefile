...
demo-stg-python:
	@bash -lc 'set -euo pipefail; test -n "$(RHEONIC_PROVIDER)" || { echo "RHEONIC_PROVIDER is required. Example: $(DEMO_STG_USAGE)" >&2; exit 1; }; test -n "$(RHEONIC_MODEL)" || { echo "RHEONIC_MODEL is required. Example: $(DEMO_STG_USAGE)" >&2; exit 1; }; test -n "$(RHEONIC_DEMO_CASE)" || { echo "RHEONIC_DEMO_CASE is required. Example: $(DEMO_STG_USAGE)" >&2; exit 1; }; env DOPPLER_PROJECT="$(DOPPLER_DEMO_PROJECT)" DOPPLER_CONFIG="$(DOPPLER_DEMO_CONFIG)" $(call maybe_demo_env,RHEONIC_PROVIDER) $(call maybe_demo_env,RHEONIC_MODEL) $(call maybe_demo_env,RHEONIC_DEMO_CASE) $(call maybe_demo_env,RHEONIC_STEP_SLEEP_MS) $(call maybe_demo_env,RHEONIC_RETRY_STORM_COUNT) $(call maybe_demo_env,RHEONIC_LOOP_COUNT) $(call maybe_demo_env,RHEONIC_TOKEN_EXPLOSION_TOKENS) $(call maybe_demo_env,RHEONIC_CAP_BREACH_TOKENS) $(call maybe_demo_env,RHEONIC_REQ_CAP_BREACH_COUNT) $(call maybe_demo_env,RHEONIC_CAP_BREACH_REQ_TOKENS) $(call maybe_demo_env,RHEONIC_NEAR_CAP_TOKENS) $(call maybe_demo_env,RHEONIC_ENVIRONMENT) $(call maybe_demo_env,RHEONIC_DEBUG) bash tests/e2e/run_stgdemo.sh python3 tests/e2e/python/demo.py'

demo-stg-node:
	@bash -lc 'set -euo pipefail; test -n "$(RHEONIC_PROVIDER)" || { echo "RHEONIC_PROVIDER is required. Example: make demo-stg-node RHEONIC_PROVIDER=google RHEONIC_MODEL=gemini-1.5-pro RHEONIC_DEMO_CASE=req_cap_breach" >&2; exit 1; }; test -n "$(RHEONIC_MODEL)" || { echo "RHEONIC_MODEL is required. Example: make demo-stg-node RHEONIC_PROVIDER=google RHEONIC_MODEL=gemini-1.5-pro RHEONIC_DEMO_CASE=req_cap_breach" >&2; exit 1; }; test -n "$(RHEONIC_DEMO_CASE)" || { echo "RHEONIC_DEMO_CASE is required. Example: make demo-stg-node RHEONIC_PROVIDER=google RHEONIC_MODEL=gemini-1.5-pro RHEONIC_DEMO_CASE=req_cap_breach" >&2; exit 1; }; env DOPPLER_PROJECT="$(DOPPLER_DEMO_PROJECT)" DOPPLER_CONFIG="$(DOPPLER_DEMO_CONFIG)" $(call maybe_demo_env,RHEONIC_PROVIDER) $(call maybe_demo_env,RHEONIC_MODEL) $(call maybe_demo_env,RHEONIC_DEMO_CASE) $(call maybe_demo_env,RHEONIC_STEP_SLEEP_MS) $(call maybe_demo_env,RHEONIC_RETRY_STORM_COUNT) $(call maybe_demo_env,RHEONIC_LOOP_COUNT) $(call maybe_demo_env,RHEONIC_TOKEN_EXPLOSION_TOKENS) $(call maybe_demo_env,RHEONIC_CAP_BREACH_TOKENS) $(call maybe_demo_env,RHEONIC_REQ_CAP_BREACH_COUNT) $(call maybe_demo_env,RHEONIC_CAP_BREACH_REQ_TOKENS) $(call maybe_demo_env,RHEONIC_NEAR_CAP_TOKENS) $(call maybe_demo_env,RHEONIC_ENVIRONMENT) $(call maybe_demo_env,RHEONIC_DEBUG) bash tests/e2e/run_stgdemo.sh node tests/e2e/node/demo.mjs'

protect-stg-python:
	@bash -lc 'set -euo pipefail; test -n "$(RHEONIC_PROVIDER)" || { echo "RHEONIC_PROVIDER is required. Example: $(PROTECT_STG_USAGE)" >&2; exit 1; }; test -n "$(RHEONIC_MODEL)" || { echo "RHEONIC_MODEL is required. Example: $(PROTECT_STG_USAGE)" >&2; exit 1; }; test -n "$(RHEONIC_SCENARIO)" || { echo "RHEONIC_SCENARIO is required. Example: $(PROTECT_STG_USAGE)" >&2; exit 1; }; env DOPPLER_PROJECT="$(DOPPLER_DEMO_PROJECT)" DOPPLER_CONFIG="$(DOPPLER_DEMO_CONFIG)" $(call maybe_demo_env,RHEONIC_PROVIDER) $(call maybe_demo_env,RHEONIC_MODEL) $(call maybe_demo_env,RHEONIC_SCENARIO) $(call maybe_demo_env,RHEONIC_STEP_SLEEP_MS) $(call maybe_demo_env,RHEONIC_RETRY_STORM_COUNT) $(call maybe_demo_env,RHEONIC_LOOP_COUNT) $(call maybe_demo_env,RHEONIC_TOKEN_EXPLOSION_TOKENS) $(call maybe_demo_env,RHEONIC_CAP_BREACH_TOKENS) $(call maybe_demo_env,RHEONIC_REQ_CAP_BREACH_COUNT) $(call maybe_demo_env,RHEONIC_CAP_BREACH_REQ_TOKENS) $(call maybe_demo_env,RHEONIC_MAX_TOKENS) $(call maybe_demo_env,RHEONIC_NEAR_CAP_SEED_TOKENS) $(call maybe_demo_env,RHEONIC_PROTECT_DECISION_TIMEOUT_MS) $(call maybe_demo_env,RHEONIC_ENVIRONMENT) $(call maybe_demo_env,RHEONIC_DEBUG) bash tests/e2e/run_stgdemo.sh python3 tests/e2e/python/demo_protect.py'

protect-stg-node:
	@bash -lc 'set -euo pipefail; test -n "$(RHEONIC_PROVIDER)" || { echo "RHEONIC_PROVIDER is required. Example: make protect-stg-node RHEONIC_PROVIDER=openai RHEONIC_MODEL=gpt-4o-mini RHEONIC_SCENARIO=cooldown" >&2; exit 1; }; test -n "$(RHEONIC_MODEL)" || { echo "RHEONIC_MODEL is required. Example: make protect-stg-node RHEONIC_PROVIDER=openai RHEONIC_MODEL=gpt-4o-mini RHEONIC_SCENARIO=cooldown" >&2; exit 1; }; test -n "$(RHEONIC_SCENARIO)" || { echo "RHEONIC_SCENARIO is required. Example: make protect-stg-node RHEONIC_PROVIDER=openai RHEONIC_MODEL=gpt-4o-mini RHEONIC_SCENARIO=cooldown" >&2; exit 1; }; env DOPPLER_PROJECT="$(DOPPLER_DEMO_PROJECT)" DOPPLER_CONFIG="$(DOPPLER_DEMO_CONFIG)" $(call maybe_demo_env,RHEONIC_PROVIDER) $(call maybe_demo_env,RHEONIC_MODEL) $(call maybe_demo_env,RHEONIC_SCENARIO) $(call maybe_demo_env,RHEONIC_STEP_SLEEP_MS) $(call maybe_demo_env,RHEONIC_RETRY_STORM_COUNT) $(call maybe_demo_env,RHEONIC_LOOP_COUNT) $(call maybe_demo_env,RHEONIC_TOKEN_EXPLOSION_TOKENS) $(call maybe_demo_env,RHEONIC_CAP_BREACH_TOKENS) $(call maybe_demo_env,RHEONIC_REQ_CAP_BREACH_COUNT) $(call maybe_demo_env,RHEONIC_CAP_BREACH_REQ_TOKENS) $(call maybe_demo_env,RHEONIC_MAX_TOKENS) $(call maybe_demo_env,RHEONIC_NEAR_CAP_SEED_TOKENS) $(call maybe_demo_env,RHEONIC_PROTECT_DECISION_TIMEOUT_MS) $(call maybe_demo_env,RHEONIC_ENVIRONMENT) $(call maybe_demo_env,RHEONIC_DEBUG) bash tests/e2e/run_stgdemo.sh node tests/e2e/node/demo_protect.mjs'
