...
def render_base_email(
    *,
    ...
    html = (
        ...
        "<tr>"
        "<td style=\"width:6px;background:#8da2ff;font-size:0;line-height:0;\">&nbsp;</td>"
        "<td style=\"width:10px;font-size:0;line-height:0;\">&nbsp;</td>"
        "<td style=\"font:700 12px/1.2 -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;letter-spacing:0.08em;text-transform:uppercase;color:#cbd5e1;\">RHEONIC</td>"
        "</tr>"
        "</table>"
        f"{eyebrow_html}"
